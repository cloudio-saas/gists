...
import { baseComponentManager, defaultCommonProps, ComponentManagerFn } from 'cloudio';
...
const CustomButtonManager: ComponentManagerFn<'CustomButton'> = (
  ...
  return {
    ...
    props: { // refer https://next-docs.cloudio.io/ui/custom-component/sample-property-definitions for more examples
      label: {
        label: 'Text',
        type: 'expression',
    ...
    description:
      'Description about my custom component... CHANGE ME!',
  };
};
